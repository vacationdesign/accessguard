...
- **You are an agency onboarding a new client.** Running an accessibility audit as part of your discovery process gives you a clear picture of the technical debt you are inheriting and lets you scope remediation accurately. Our [accessibility guide for web agencies](/blog/accessibility-for-web-agencies) covers how to build accessibility into your agency workflow from proposal to delivery.
