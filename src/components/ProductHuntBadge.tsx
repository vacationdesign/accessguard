...
export default function ProductHuntBadge() {
  return (
    <aside
      aria-label="Product Hunt feature badge"
    ...
    >
      <a
        ...
        className="flex items-center gap-2 rounded-full bg-white px-4 py-2.5 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-200 group"
      ...
      >
        ...
        <span className="text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors">
          Featured on{" "}
          <span className="text-[#B7451A]">Product Hunt</span>
        </span>
      </a>
    </aside>
  );
